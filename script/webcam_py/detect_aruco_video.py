...
python3 detect_aruco_video.py --type DICT_5X5_100 --camera False --video filename.avi
'''
...
while True:
	...
	fps = 1/(cTime-pTime)
	pTime = cTime
	cv2.putText(detected_markers, f"FPS: {int(fps)}", (20, 50), cv2.FONT_HERSHEY_PLAIN, 3, (0, 255, 0), 3)
	print(f"FPS: {int(fps)}")
